...
This function determines if the watermelon can be divided in the way Eric and Cartman want.

Parameters:
n : int
An integer representing the weight of the watermelon in kilos.
Constraints: 1 ≤ w ≤ 100

Returns:
bool
True if the watermelon can be divided into two parts, each part having an even weight, and False otherwise.
